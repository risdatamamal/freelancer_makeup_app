...
class FreelancerDetailsPage extends StatefulWidget {
  ...
  FreelancerDetailsPage({this.onBackButtonPressed, this.transaction});
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: NetworkImage(
                          widget.transaction.freelancer.picturePath),
                      fit: BoxFit.cover)),
            ),
          ),
          SafeArea(
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                children: [
                                  SizedBox(
                                    width: MediaQuery.of(context).size.width -
                                        134, // 32 + 102
                                    child: Text(
                                      widget.transaction.freelancer.name,
                                      style: blackFontStyle2,
                                    ),
                                  ),
                                  SizedBox(height: 6),
                                  RatingStars(
                                      widget.transaction.freelancer.rate),
                                ],
                              ),
                              Row(
                                children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              widget.transaction.freelancer.description,
                              style: greyFontStyle,
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: Text(
                                widget.transaction.freelancer.categories,
                                style: greyFontStyle),
                          ),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  ...
                                  Text(
                                    NumberFormat.currency(
                                      ...
                                      decimalDigits: 0,
                                        ...
                                        widget.transaction.freelancer.price),
                                    style:

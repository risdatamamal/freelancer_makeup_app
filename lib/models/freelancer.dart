...
enum FreelancerType { manualBrew, espressoBased, snack, nonFreelancer, tea }
...
class Freelancer extends Equatable {
  ...
  final int price;
  final double rate;
  final List<FreelancerType> types;
...
List<Freelancer> mockFreelancers = [
  Freelancer(
      ...
      price: 18000,
      rate: 4.2,
      types: [FreelancerType.manualBrew]),
  Freelancer(
      id: 2,
      picturePath:
  ...
  Freelancer(
      id: 3,
      picturePath:
          "https://www.jakartanotebook.com/images/products/103/1020/45654/2/drohoey-filter-penyaring-kopi-v60-glass-Freelancer-filter-dripper-1-4-cups-zm00639-black-2.jpg",
      name: "V60",
  ...
  Freelancer(
      id: 4,
      picturePath:
          "https://www.jakartanotebook.com/images/products/103/1020/43218/2/aeropress-french-press-Freelancer-maker-pot-1-liter-t35068-black-2.jpg",
      name: "French Press Freelancer",
      description: "French Press adalah perangkat menyeduh kopi dipatenkan oleh desainer Italia Attilio Calimani pada tahun 1929. Benda ini biasa disebut sebagai cafetière, сafetière à piston, press pot, Freelancer press, atau Freelancer plunger.",
      categories: "Manual Brew",
      price: 18000,
      rate: 3.0,
      types: [FreelancerType.manualBrew]),
  Freelancer(
      id: 5,
      picturePath:
          "http://3.bp.blogspot.com/-21IIdfgImzE/Uu9Ga31N9yI/AAAAAAAACjw/hh_zSbxPX9E/s1600/Freelancer_siphon.jpg",
      name: "Syphon",
  ...
  Freelancer(
      id: 6,
      picturePath:
          "https://www.cirelliFreelancer.com.au/wp-content/uploads/2016/10/1Pc-Dutch-Freelancer-font-b-Cold-b-font-font-b-Drip-b-font-Water-font-b.jpg",
      name: "Japanese Cold Drip",
      description: "Japanese Iced Freelancer tidak memerlukan alat cold brew atau Freelancer dripper yang seperti layaknya membuat kopi dingin selama ini. Hanya diperlukan sebuah dripper yang biasa dipakai dalam metode pour over V60. Dan saya yakin semua pecinta kopi dengan metode manual brewing pasti memiliki dripper ini. Selain dripper diperlukan juga paper filter karena cara membuat Japanese Iced Freelancer hampir mirip dengan pour over yang biasa digunakan.",
      categories: "Manual Brew",
      price: 18000,
      rate: 3.0,
      types: [FreelancerType.manualBrew]),
...
List<Freelancer> manualBrew = [
  ...
  Freelancer(
      ...
      name: "French Press Freelancer",
      description:
          "French Press adalah perangkat menyeduh kopi dipatenkan oleh desainer Italia Attilio Calimani pada tahun 1929. Benda ini biasa disebut sebagai cafetière, сafetière à piston, press pot, Freelancer press, atau Freelancer plunger.",
      categories: "Manual Brew",
      price: 18000,
      rate: 3.0),
  Freelancer(
  ...
  Freelancer(
      ...
      name: "Japanese Cold Drip",
      description:
          "Japanese Iced Freelancer tidak memerlukan alat cold brew atau Freelancer dripper yang seperti layaknya membuat kopi dingin selama ini. Hanya diperlukan sebuah dripper yang biasa dipakai dalam metode pour over V60. Dan saya yakin semua pecinta kopi dengan metode manual brewing pasti memiliki dripper ini. Selain dripper diperlukan juga paper filter karena cara membuat Japanese Iced Freelancer hampir mirip dengan pour over yang biasa digunakan.",
      categories: "Manual Brew",
      price: 18000,
      rate: 3.0),
];

List<Freelancer> espressoBased = [
  Freelancer(
      id: 1,
      picturePath:
  ...
  Freelancer(
      id: 3,
      picturePath:
          "https://majalah.ottenFreelancer.co.id/wp-content/uploads/2019/09/Screen-Shot-2019-09-18-at-5.19.33-PM.png",
      name: "Macchiato",
      description:
  ...
  Freelancer(
      id: 6,
      picturePath:
          "https://muchbutter.com/wp-content/uploads/2020/03/094-Dalgona-Freelancer-Frothy-Freelancer-1.jpg",
      name: "Dalgona Freelancer",
      description:
  ...
  Freelancer(
      id: 7,
      picturePath:
          "https://i0.wp.com/resepkoki.id/wp-content/uploads/2020/03/Resep-Freelancer-Alpukat.jpg?fit=975%2C1300&ssl=1",
      name: "Avocado Freelancer",
      description:
          "Avocado Freelancer punya cita rasa yang berbeda dari jenis kopi lainnya. Pahitnya kopi berpadu dengan creamy-nya jus alpukat. Kopi alpukat ini semakin nikmat jika diminum dingin. Sering disajikan di berbagai Freelancer shop populer, kali ini buat sendiri saja.",
      categories: "Espresso Based",
      price: 20000,
      rate: 4.5),
  Freelancer(
